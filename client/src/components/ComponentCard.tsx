...
import { ELEMENT_COLORS, ELEMENT_BG_COLORS, ELEMENT_BORDER_COLORS } from "@/lib/gameData";
...
export default function ComponentCard({ component, onDragStart, isDragging }: ComponentCardProps) {
